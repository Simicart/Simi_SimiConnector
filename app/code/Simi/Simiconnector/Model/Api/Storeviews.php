...
class Storeviews extends Apiabstract
{
    ...
    public function show()
    {
        ...
        $parameters = $cmsData['params'];


        $EpayNC_payment = [
            'publish_test_key' => $this->getStoreConfig('epaync/general/rest_public_key_test')
        ];
        if(isset($parameters['fields'])){
            $objectLyranetworkHeade = new LyranetworkHeade;
            $EpayNC_payment = $this->simiObjectManager->create('Lyranetwork\Epaync\Model\Method')->getGatewayUrl();
        }
        ...
        $additionInfo = [
            ...
            'enable_checkout_management' => $this->getStoreConfig('simiconnector/hideaddress/hideaddress_enable'),
            'allowed_countries' => $this->getAllowedCountries(),
            'EpayNC' => $EpayNC_payment,
